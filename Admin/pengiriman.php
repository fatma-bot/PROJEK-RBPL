...
<body>
    <div class="sidebar" id="sidebar">
        ...
        <ul>
            ...
            <li style="background-color:white; color:black; border-radius:10px;"><i class="fas fa-shipping-fast icon"></i> <span class="label"><a href="#" style="text-decoration: none; color:black;">Pengelolaan pengiriman</a></span></li>
            <li><i class="fas fa-wallet icon" style="color:black;"></i> <span class="label"><a href="#" style="text-decoration: none; color:black;">Pengelolaan Pembayaran</a></span></li>
            <li><i class="fas fa-sign-out-alt icon" style="color:black;"></i> <span class="label"><a href="#" style="text-decoration: none; color:black;">Logout</a></span></li>
        </ul>
    </div>
