...
<div class="container">
    <form action="submit_pengiriman.php?id=<?php echo $data['idPesanan']; ?>" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" id="jenisPengiriman" name="jenisPengiriman" value="<?php echo $data['jenisPengiriman']; ?>" readonly>

        <label for="pickup_date">Tanggal Pengambilan:</label>
        <input type="date" id="pickup_date" min ="<?php echo $today; ?>" name="tglAmbil">
        ...
        <div class="upload-box">
            ...
            <input type="file" id="proof_file" name="tandaPengambilan" accept="image/*" required>
        </div>
